...
<div class="p-6 md:p-8 space-y-6">
  ...
  <div class="flex flex-col md:flex-row justify-between gap-4">
    ...
    <button class="bg-scientific-600 hover:bg-scientific-700 text-white font-medium py-2 px-4 rounded-lg flex items-center gap-2 transition-colors shadow-sm">
