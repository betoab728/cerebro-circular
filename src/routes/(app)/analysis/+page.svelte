          ...
          <div class="space-y-6">
            ...
            <div>
              ...
              {#if analysisResult.elementalSummary}
                <div class="mt-4 p-4 bg-blue-50/50 rounded-lg border border-blue-100 text-sm text-gray-600 italic">
                    <svg class="w-4 h-4 inline-block mr-1 text-blue-400 -mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                    {analysisResult.elementalSummary}
                </div>
              {/if}
            </div>
          </div>
